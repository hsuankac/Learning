...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Consumer_t, stringdata0) + ofs), len 
...
const QMetaObject Consumer::staticMetaObject = { {
    ...
    qt_meta_stringdata_Consumer.offsetsAndSize,
    qt_meta_data_Consumer,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Consumer_t
